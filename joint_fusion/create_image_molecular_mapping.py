...
output_csv_path = base_dir + './mapped_data_28Jan.csv'
# json file with the mapped data
output_json_path = base_dir + './mapped_data_28Jan.json'

rnaseq_clinical_df = pd.read_csv('./rnaseq_clinical_28Jan.csv')
png_files_dict = {}
# set_trace()
...
print("Number of WSIs with more than 200 tiles: ", count_gt_200)
