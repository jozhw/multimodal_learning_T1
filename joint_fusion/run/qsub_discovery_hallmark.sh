...
# TEST step, Hallmark. Runs run_discovery_pathway_tests.sh -> permutation / GSEA / ORA into
# pathway_interpret_hallmark/. REQUIRES the gene bundle from qsub_interpret_hallmark.sh (run
...
./joint_fusion/run/run_discovery_hallmark.sh
