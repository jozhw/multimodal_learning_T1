...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_wsi_path', type=str,
                        ...
                        default='/lus/eagle/clone/g2/projects/GeomicVar/tarak/multimodal_learning_T1/preprocessing/TCGA_WSI/LUAD_all/svs_files/FFPE_tiles_single_sample_per_patient_20X/tiles/256px_128um/combined/',
    ...
    parser.add_argument('--pooling', type=str, default='average', choices=['average', 'learned_weighted', 'attention'],
    ...
    filename = "./WSI_embeddings_average_uni_29Jan.json"
