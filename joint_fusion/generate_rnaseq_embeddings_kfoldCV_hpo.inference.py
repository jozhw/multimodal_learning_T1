...
if __name__ == "__main__":
    ...
    parser.add_argument('--beta', type=float, default=1e-3, help='Beta parameter for VAE')
    parser.add_argument('--num_epochs', type=int, default=3000, help='Number of epochs for training')
