...
parser.add_argument(
    ...
    type=float,
    default=0.9,
    help="StepLR decays the learning rate of each parameter group by gamma every step_size epochs",
)
parser.add_argument(
...
parser.add_argument(
    "--profile", type=str, default=False, help="whether to profile or not"
)
parser.add_argument(
    "--use_mixed_precision",
    type=str,
