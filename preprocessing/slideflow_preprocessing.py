...
work_dir = '/lus/eagle/clone/g2/projects/GeomicVar/tarak/multimodal_learning_T1/preprocessing/TCGA_WSI/LUAD_all/svs_files/FFPE_tiles_otsu_B/'
...
dataset.extract_tiles(qc='otsu', #  ‘otsu’, ‘blur’, ‘both’, or None
                      save_tiles=True,
                      save_tfrecords=True,
